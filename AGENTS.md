...
- When proposing line-by-line translations for review, use a Markdown table with the original English text in the left `Original` column and the Russian translation in the right `Предлагаемый перевод` column.
