...
description: Злоумышленники могут создавать или использовать каналы связи в киберпространстве для командования и управления. Для такого канала может использоваться любой сетевой протокол, сервис, репозиторий, ретранслятор или...
generated: true
...
tactics:
    - AML.TA0014
title: Канал связи в киберпространстве
url: /techniques/AML.T0072/
---

Злоумышленники могут создавать или использовать каналы связи в киберпространстве для командования и управления. Для такого канала может использоваться любой сетевой протокол, сервис, репозиторий, ретранслятор или другое промежуточное звено; обмен может происходить синхронно либо асинхронно.

Техники, описывающие конкретные протоколы, сервисы, ретрансляторы, методы туннелирования и схемы связи, представлены в тактике ATT&CK [Командование и управление](https://attack.mitre.org/tactics/TA0011/).
