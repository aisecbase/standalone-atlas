...
<a class="relation-item" href="/studies/AML.CS0070/"><span class="relation-id">AML.CS0070</span><strong>Злоумышленник использовал Hermes Agent на базе DeepSeek при попытках эксплуатации Langflow и n8n</strong><span class="relation-meta">Актор: Chinese-speaking threat actor using the aliases knaithe and KnYuan / Тактика: AML.TA0002 Разведка</span><p>DeepSeek исследовал Langflow, определил, какие сведения требовалось получить и какие необходимые условия должны были выполняться, а затем с учётом полученных результатов выбрал дальнейшие действия по разведке.</p></a>
