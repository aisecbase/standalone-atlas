...
<a class="relation-item" href="/studies/AML.CS0069/"><span class="relation-id">AML.CS0069</span><strong>Кибершпионская кампания GTG-1002 с использованием Claude Code</strong><span class="relation-meta">Актор: GTG-1002 / Тактика: AML.TA0005 Выполнение</span><p>Обращаясь к Claude Code, GTG-1002 ложно заявляла о наличии разрешения, выдавала себя за специалиста по защитной кибербезопасности и ставила на первый взгляд безобидные задачи.</p></a>
</div>
