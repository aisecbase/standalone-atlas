...
<div class="relation-list">
<a class="relation-item" href="/mitigations/AML.M0008/"><span class="relation-id">AML.M0008</span><strong>Валидация ИИ-модели</strong><p>Перед публикацией в каталоге репозитории моделей проверяют поступающие материалы на наличие бэкдоров, утечек данных, состязательного воздействия и неожиданного поведения.</p></a>
