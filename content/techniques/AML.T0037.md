...
<a class="relation-item" href="/studies/AML.CS0069/"><span class="relation-id">AML.CS0069</span><strong>Кибершпионская кампания GTG-1002 с использованием Claude Code</strong><span class="relation-meta">Актор: GTG-1002 / Тактика: AML.TA0009 Сбор материалов</span><p>Доступ, полученный в результате первоначальной компрометации, также позволил джейлбрейкнутому агенту Claude от GTG-1002 собрать учётные данные, конфигурации систем и чувствительные эксплуатационные данные, хранившиеся в скомпрометированных системах.</p></a>
</div>
