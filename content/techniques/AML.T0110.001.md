...
description: Злоумышленники могут отравить исполняемую имплементацию инструмента ИИ-агента, чтобы обычный вызов инструмента приводил к неавторизованному поведению или скрытым побочным эффектам. Инструмент может продолжать...
generated: true
