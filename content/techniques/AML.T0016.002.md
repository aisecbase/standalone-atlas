...
Им может потребоваться выполнить джейлбрейк модели (см. [джейлбрейк LLM](/techniques/AML.T0054)), чтобы обойти ограничения на типы генерируемых ею ответов. Им также может потребоваться нарушить установленные разработчиком модели условия использования.
