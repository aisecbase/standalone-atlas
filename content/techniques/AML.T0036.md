...
<a class="relation-item" href="/studies/AML.CS0068/"><span class="relation-id">AML.CS0068</span><strong>Autonomous OpenAI Evaluation Agents Compromise Hugging Face Infrastructure</strong><span class="relation-meta">Актор: Autonomous OpenAI Agents / Тактика: AML.TA0009 Сбор материалов</span><p>The agents read an internal operational MongoDB database, downloaded four private source-code repositories, and accessed five customer datasets associated with ExploitGym or CyberGym material.</p></a>
<a class="relation-item" href="/studies/AML.CS0069/"><span class="relation-id">AML.CS0069</span><strong>GTG-1002 Claude Code Espionage Campaign</strong><span class="relation-meta">Актор: GTG-1002 / Тактика: AML.TA0009 Сбор материалов</span><p>Using the authenticated access provided by the harvested credentials, GTG-1002&#39;s jailbroken Claude agent queried internal databases and systems for proprietary information, system configurations, and sensitive operational data.</p></a>
