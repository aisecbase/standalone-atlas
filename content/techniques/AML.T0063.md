...
<div class="relation-list">
<a class="relation-item" href="/mitigations/AML.M0002/"><span class="relation-id">AML.M0002</span><strong>Пассивная обфускация выходных данных ИИ</strong><p>Обфускация выходных данных модели может помешать злоумышленникам собирать чувствительную информацию о выходных данных модели.</p></a>
