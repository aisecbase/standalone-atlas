...
<div class="relation-list">
<a class="relation-item" href="/mitigations/AML.M0009/"><span class="relation-id">AML.M0009</span><strong>Использование мультимодальных сенсоров</strong><p>Использование разных сенсоров может затруднить злоумышленнику с физическим доступом компрометацию системы и получение вредоносных результатов.</p></a>
</div>
