...
description: Исследователи Zenity в августе 2024 года провели учение красной команды, в ходе которого им удалось манипулировать Microsoft 365 Copilot.[[twitter]] Атака злоупотребляла тем, что Copilot загружает полученные письма в...
generated: true
