...
procedure:
    ...
    - description: Когда позднее пользователь обратился к Copilot, тот извлёк вредоносное письмо и включил его в свой контекст, что привело к срабатыванию промпт-инъекции.
      description_line: Когда позднее пользователь обратился к Copilot, тот извлёк вредоносное письмо и включил его в свой контекст, что привело к срабатыванию промпт-инъекции.
      tactic: AML.TA0005
