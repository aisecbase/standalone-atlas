...
procedure:
    ...
    - description: У дистиллированных моделей нет защитных ограничений Claude, из-за чего пользователи могут столкнуться с вредоносными ответами и поведением модели.
      description_line: У дистиллированных моделей нет защитных ограничений Claude, из-за чего пользователи могут столкнуться с вредоносными ответами и поведением модели.
      tactic: AML.TA0011
      tactic_name: Воздействие
