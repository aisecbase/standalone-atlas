...
description: Проверяйте криптографическую контрольную сумму всех ИИ-артефактов, чтобы убедиться, что файл не был изменен злоумышленником.
generated: true
...
Проверяйте криптографическую контрольную сумму всех ИИ-артефактов, чтобы убедиться, что файл не был изменен злоумышленником.


## Связанные техники

<div class="relation-list">
<a class="relation-item" href="/techniques/AML.T0002.001/"><span class="relation-id">AML.T0002.001</span><strong>Модели</strong><p>Внедрите надлежащую проверку подписей, чтобы небезопасные ИИ-модели не попадали в систему.</p></a>
<a class="relation-item" href="/techniques/AML.T0010/"><span class="relation-id">AML.T0010</span><strong>Компрометация цепочки поставок ИИ</strong><p>Внедрите надлежащую проверку подписей, чтобы небезопасные ИИ-артефакты не попадали в систему.</p></a>
